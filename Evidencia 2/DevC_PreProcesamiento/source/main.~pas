...
PBreakPointEntry = ^TBreakPointEntry;
  TMainForm = class(TForm)
    ...
    preprocesscurrentfile1: TMenuItem;
    ...
    procedure preprocesscurrentfile1Click(Sender: TObject);
...
procedure TMainForm.preprocesscurrentfile1Click(Sender: TObject);
var
  e: TEditor;
begin
if fCompiler.Compiling then
  ...
  if not PrepareForCompile then
    Exit;
  {fCompiler.Compile(e.FileName);}
  fCompiler.Preprocesar(e.FileName);
  Application.ProcessMessages;
end;
